...
# load dataset
DataTrain = pd.read_excel(r'C:\Users\twg\Desktop\AverageTrain.xlsx', header=None, names=col_names)
DataTest = pd.read_excel(r'C:\Users\twg\Desktop\AverageTest.xlsx', header=None, names=col_names)
DataValid = pd.read_excel(r'C:\Users\twg\Desktop\AverageValidation.xlsx', header=None, names=col_names)
